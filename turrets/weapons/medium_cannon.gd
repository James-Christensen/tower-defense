class_name MediumCannon extends Weapon
@onready var med_rocket_spawn_point: Marker2D = %MedRocketSpawnPoint
...
func attack() -> void:
	...
	rocket.global_transform = med_rocket_spawn_point.global_transform
